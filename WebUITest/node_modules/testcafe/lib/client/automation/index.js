						...
						"type": {
							...
							"type-text.js": function (exports, module, require) {
								...
								function _typeTextToTextEditable(element, text) {
								    ...
								    var needProcessTextInput = !browserUtils.isChrome || eventSimulator.beforeInput(element, text);

								    if (!needProcessTextInput) return;

								    var needProcessInput = simulateTextInput(element, text);

								    if (needProcessInput && browserUtils.isSafari) needProcessInput = eventSimulator.beforeInput(element, text);
